      ...
      <main className="flex-1 flex items-center justify-center p-4">
        <div className="max-w-[400px] w-full p-8 bg-card border border-border rounded-[20px] shadow-sm">
          <div className="flex flex-col items-center mb-6 text-center">
            <h2 className="text-xl font-semibold tracking-tight text-foreground mb-1 font-sans">
              Welcome back
            </h2>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            {error && (
              <div className="text-destructive text-xs font-semibold text-center font-sans">
                {error}
              </div>
            )}
            ...
            <div className="text-center text-xs mt-5">
              <Link
                to="/register"
                className="text-muted-foreground hover:text-foreground font-sans font-medium transition-colors"
              >
