...
export default function Reports() {
  ...
  const handleShare = () => {
    setIsSharing(true);
    apiFetch(`http://localhost:8000/api/reports/${reportId}/share/`, { method: 'POST' })
      .then(res => res.json())
      .then(data => {
        if (data.share_token) {
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-card border border-border rounded-[20px] shadow-lg w-full max-w-md p-6 relative">
              ...
              <p className="text-xs text-muted-foreground font-sans mb-6">
                Anyone with this link will be able to view this report without logging in.
              </p>
              ...
              <div className="flex gap-4 items-center shrink-0">
                ...
                <span className={`px-2.5 py-1 rounded-full text-[9px] font-sans font-semibold border ${
                  report.report_type === 'ml' 
                    ? 'bg-[#002a45] text-[#0099ff] border-[#0099ff]/40' 
